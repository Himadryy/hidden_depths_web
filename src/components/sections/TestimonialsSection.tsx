    ...
    <section className="section-bloom bg-[var(--background)]">
      <Container>
            ...
            >
              <div className="card-testimonial h-full flex flex-col">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-[var(--glass-border)]">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[var(--accent)] to-[var(--accent-deep)] flex items-center justify-center">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-16 pt-12 border-t border-[var(--glass-border)]"
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50">
            ...
            {['APA', 'NIMH', 'Psychology Today', 'GoodTherapy'].map((org) => (
              <span key={org} className="text-lg font-semibold text-[var(--foreground)]">
                {org}
              </span>
            ))}
          </div>
