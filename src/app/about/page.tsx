      ...
      <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] pt-24 pb-12">
        ...
        <section className="relative py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 bg-gradient-to-r from-[var(--foreground)] via-[var(--text-muted)] to-[var(--text-muted)] bg-clip-text text-transparent">
              About Hidden Depths
            </h1>
        ...
        <article className="max-w-3xl mx-auto px-6 space-y-16">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[var(--glass-panel)] p-6 rounded-xl border border-[var(--glass-border)] hover:border-[var(--accent)]/50 transition-colors">
            ...
            <section className="text-center pt-8">
              <h2 className="text-3xl font-serif mb-6 text-[var(--foreground)]">Ready to Take the First Step?</h2>
              <Link
