...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (explicit navigation to /login as required by the test steps).
        await page.goto("http://localhost:3000/login", wait_until="commit", timeout=10000)
        
        # -> Fill the email and password fields (indices 614 and 615) and click the 'SIGN IN' button (index 616) to attempt login.
        ...
        # -> Navigate to /admin/insights (http://localhost:3000/admin/insights) to verify the non-admin account receives an access denied state.
