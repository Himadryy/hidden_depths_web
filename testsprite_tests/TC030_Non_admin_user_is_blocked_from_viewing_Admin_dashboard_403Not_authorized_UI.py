...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login page (http://localhost:3000/login) to open the auth modal.
        await page.goto("http://localhost:3000/login", wait_until="commit", timeout=10000)
        
        # -> Type 'nonadmin@example.com' into the email field (auth-email), type 'WrongPassword123!' into the password field (auth-password), then click the SIGN IN button.
