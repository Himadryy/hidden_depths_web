...
async def run_test():
    ...
    try:
        ...
        # -> Input the login email into index 273, input the password into index 274, then click the 'SIGN IN' button at index 275.
        ...
        await expect(frame.locator('xpath=//button[normalize-space(.)="Edit"]').first).to_be_visible(timeout=3000)
        await expect(frame.locator('text=E2E Insight Title (Updated)').first).to_be_visible(timeout=3000)
