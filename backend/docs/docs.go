...
const docTemplate = `{
    ...
    "paths": {
        "/admin/bookings": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Status filter (paid, pending, failed, cancelled, confirmed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search by name, email, booking id, or user id",
                        "name": "search",
                        "in": "query"
                    }
                ],
        ...
        "/admin/stats": {
            "get": {
                ...
                "description": "Returns aggregate metrics for the admin dashboard.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/test-email": {
            "post": {
                ...
                "description": "Sends a test email to verify Resend integration. Admin only.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Himadryy_hidden-depths-backend_internal_models.Insight"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Himadryy_hidden-depths-backend_internal_models.Booking"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Payment initiated (paid sessions)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "201": {
                        "description": "Booking confirmed (free sessions)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        "github_com_Himadryy_hidden-depths-backend_internal_models.Booking": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
        ...
        "github_com_Himadryy_hidden-depths-backend_internal_models.Insight": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
    ...
    "tags": [
        ...
        {
            "description": "Insight cards for the homepage carousel",
            "name": "Insights"
        },
        {
            "description": "Admin-only endpoints for managing content",
            "name": "Admin"
        },
        {
